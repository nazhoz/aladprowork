...
const MediaForm = () => {
  return (
    <div className="flex flex-col justify-start mr-2 mt-3 w-[30%]">
      <div className="w-[100%] flex flex-col justify-start items-center py-2 bg-formbackgroundcolor  shadow-md rounded-lg">
        ...
        <div className=" w-[95%] px-2 py-2">
          <label
            htmlFor="file"
            className="flex flex-col justify-center w-[100%] h-[180px] border-2 border-dashed border-black items-center p-[5px] cursor-pointer rounded-lg"
          >
            <span>
              <svg
        ...
        <div className="text-[15px] font-semibold w-[90%] mt-2">
          <input
            className="border-[1px] px-2 h-[35px] rounded-md text-xs w-[100%]  border-inputs outline-none focus:border-inputbordercolor"
            type="text"
